...
const handleGetAllEvents = async () => {
    const response = await axios.get('https://event-booking-server.vercel.app/events');
    return response.data;
};

const handleSearchAllEvent = async (keyword: string) => {
    const response = await axios.get('https://event-booking-server.vercel.app/events/search', {
        params: {
            query: keyword,
        },
    });
...
const handlePublishEvent = async (id: string, setLoading: any, setEventList: any) => {
    setLoading(true);
    await axios.put(`https://event-booking-server.vercel.app/events/update_status/${id}`);
    setTimeout(async () => {
